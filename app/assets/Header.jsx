...
import { UseCont } from './Context/page'
const Header = () => {
    ...
    items-center justify-between`}>
            ...
            <div id='icons' className='w-[200px] flex justify-around items-center'>
                <Image className=' cursor-pointer'
                 src={'/icons/house.png'} width={35} height={30}></Image>
                <Image className=' cursor-pointer'
                 src={'/icons/trolley.png'} width={35} height={30}></Image>
                <Image className=' cursor-pointer'
                onClick={()=>setDark(!dark)}
                 src={dark?'/icons/dark.png':'/icons/light.png'} width={25} height={25}></Image>
            </div>
        </div>
    )
}
